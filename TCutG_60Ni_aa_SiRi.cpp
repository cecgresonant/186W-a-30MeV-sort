...
void TCutG_60Ni_aa_SiRi(){
    ...
    banana_b1f0->Draw();
    TCutG *cutg_b1f0 = new TCutG("cutg_b1f0",19);
    cutg_b1f0->SetVarX(" E detector 1 strip 0");
    cutg_b1f0->SetVarY("#DeltaE ");
    cutg_b1f0->SetTitle("Graph");
    cutg_b1f0->SetFillStyle(1000);
    cutg_b1f0->SetPoint(0,10959.3,4327.32);
    cutg_b1f0->SetPoint(1,11172.5,4301.63);
    cutg_b1f0->SetPoint(2,11341.3,4308.05);
    cutg_b1f0->SetPoint(3,11590,4385.11);
    cutg_b1f0->SetPoint(4,11714.3,4552.05);
    cutg_b1f0->SetPoint(5,11705.4,4757.53);
    cutg_b1f0->SetPoint(6,11607.7,4828.16);
    cutg_b1f0->SetPoint(7,11376.8,4905.21);
    cutg_b1f0->SetPoint(8,10808.3,4988.68);
    cutg_b1f0->SetPoint(9,10506.3,4975.84);
    cutg_b1f0->SetPoint(10,10177.7,4943.74);
    cutg_b1f0->SetPoint(11,10097.7,4802.47);
    cutg_b1f0->SetPoint(12,10097.7,4654.79);
    cutg_b1f0->SetPoint(13,10142.1,4500.68);
    cutg_b1f0->SetPoint(14,10337.5,4442.89);
    cutg_b1f0->SetPoint(15,10577.4,4359.42);
    cutg_b1f0->SetPoint(16,10870.5,4295.21);
    cutg_b1f0->SetPoint(17,11003.7,4314.47);
    cutg_b1f0->SetPoint(18,10959.3,4327.32);
    cutg_b1f0->Draw("same");
