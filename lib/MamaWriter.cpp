...
int MamaWriter::Write(std::ofstream& fp, Histogram1D* h)
{
    ...
    double cal[3] = { (double)xax.GetLeft(), (double)xax.GetBinWidth(), 0 };
...
int MamaWriter::Write(std::ofstream& fp, Histogram2D* h)
{
    ...
    double cal[6] = {
        (double)xax.GetLeft(), (double)xax.GetBinWidth(), 0,
        (double)yax.GetLeft(), (double)yax.GetBinWidth(), 0
    };
